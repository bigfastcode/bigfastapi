...
async def get_blogs(
    ...
    return await _services.get_user_blogs(user=user, db=db)
...
async def update_blog(
    ...
    return await _services.update_blog(blog=blog, blog_id=blog_id, db=db)
...
async def delete_blog(
    ...
    return await _services.delete_blog(blog_id=blog_id, db=db, user=user)