...
class Schedule(database.Base):
    ...
    frequency_of_reminder_before_due_date = Column(String(255), index=True)
    first_template = Column(String(255), index=True)
    second_template = Column(String(255), index=True)
    third_template = Column(String(255), index=True)
    template_after_due_date = Column(String(255), index=True)
    frequency_of_reminder_after_due_date = Column(String(255), index=True)
